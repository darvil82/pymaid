...
def parse_args():
	...
	pargs.add_argument(
		"-d", "--direction", help="The direction of the diagram",
		type=str, default="TB", choices=DIRECTIONS
	)
	pargs.add_argument(
		"-o", "--output", help="The output file to append the content to",
		type=argparse.FileType("a")
	)
	pargs.add_argument(
		"-m", "--no-md", help="Do not output markdown block",
		action="store_false"
	)
	...
	class_args.add_argument("-e", "--no-extra", action="store_false", help="Don't show parents recursively")
